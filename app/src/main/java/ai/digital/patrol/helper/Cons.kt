 ...
 *     Cons.kt
 *     Created by ImamSyahrudin on 18/8/2022
 *     Copyright © 2022 imamSyahrudin. All rights reserved.
 *
 *     Last modified 8/18/22, 5:44 AM
 */
...
object Cons {
    ...
    const val SCHEDULE_SYNC_WORKER_REPORT = "schedule-sync-data-report"

    const val PATROL_TIME_START =30
    const val PATROL_TIME_END = -30
